...
#+begin_src emacs-lisp
  ...
  ----------------------------------------------------------------
    ...
    _s-m_: current model                 _rc_: console
      _c_: controller                    _rr_: rake
    _s-c_: current controller
      _d_: decorator
    _s-d_: current decorator
      _v_: view
    _s-v_: current view
    "
             ("c"   projectile-rails-find-controller            nil)
             ("s-c" projectile-rails-find-current-controller    nil :color blue)
             ("d"   cnb/projectile-rails-find-decorator         nil)
             ("s-d" cnb/projectile-rails-find-current-decorator nil)
             ("m"   projectile-rails-find-model                 nil)
             ("s-m" projectile-rails-find-current-model         nil)
             ("v"   projectile-rails-find-view                  nil)
             ("s-v" projectile-rails-find-current-view          nil)
