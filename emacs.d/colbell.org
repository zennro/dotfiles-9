...
Function that allows toggling between dark and light Solarized themes.
...
This needs to be installed prior to ace-window otherwise it errors out. This occurs
only when installing, not when loading.
...
Git Gutter doesn't work with flycheck.
...
Git gutter fringe works with Flycheck
