  ...
  (use-package hydra
    ...
    (progn
      ...
      (key-chord-define-global
       "YY"
       (defhydra cnb-hydra-win-functions (global-map "<f5>")
         "window functions"
         ("h" hydra-move-splitter-left "split L")
         ("j" hydra-move-splitter-down "split D")
         ("k" hydra-move-splitter-up "split U")
         ("l" hydra-move-splitter-right "split R")
