...
#+HTML_HEAD_EXTRA: Emacs Configuration as pretty HTML. See <tt>init.org</tt> for the actual configuration source.
#+HTML_LINK_HOME:
#+HTML_LINK_UP:
#+HTML_MATHJAX:
...
I'm currently converting my Emacs configuration to an Org file which
...
#+begin_src emacs-lisp
    (use-package yasnippet
      ...
      :bind (("C-S-c y" . yas-insert-snippet))
