...
;;   :init
;;   (progn
;;     (add-hook 'paradox-menu-mode-hook 'cnb/package-menu-hook)))

;; (use-package package
;;   :init
;;   (progn
;;     (add-hook 'package-menu-mode-hook 'cnb/package-menu-hook)))
